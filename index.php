		...
		<!-- Feature 1 -->
			<article id="first" class="container box style1 right">
				...
				<div class="inner">
					<header>
						<h2><br />
						各種イベントでのコンパニオンやMC手配をお考えの企業様へ</h2>
					</header>
		...
		<!-- Portfolio -->
			<article class="container box style2" id="works">
				...
				<div class="inner gallery">
					<div class="row gtr-0">
						<div class="col-3 col-12-mobile"><a href="images/fulls/01.jpg" class="image fit"><img src="images/thumbs/01.jpg" alt="" title="Ad infinitum" /></a><p class="captions">MODEL</p></div>
                        
						<div class="col-3 col-12-mobile"><a href="images/fulls/02_1.png" class="image fit"><img src="images/thumbs/02.jpg" alt="" title="Dressed in Clarity" /></a><p class="captions">コンパニオン</p></div>
						<div class="col-3 col-12-mobile"><a href="images/fulls/03.jpg" class="image fit"><img src="images/thumbs/03.jpg" alt="" title="Raven" /></a><p class="captions">MC</p></div>
					</div>
